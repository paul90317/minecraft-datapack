execute if score @s mbomb.suc matches 64.. run summon item ~ ~ ~ {Item:{id:"minecraft:blackstone",Count:64b}}
execute if score @s mbomb.suc matches 32..63 run summon item ~ ~ ~ {Item:{id:"minecraft:blackstone",Count:32b}}
execute if score @s mbomb.suc matches 16..31 run summon item ~ ~ ~ {Item:{id:"minecraft:blackstone",Count:16b}}
execute if score @s mbomb.suc matches 8..15 run summon item ~ ~ ~ {Item:{id:"minecraft:blackstone",Count:8b}}
execute if score @s mbomb.suc matches 4..7 run summon item ~ ~ ~ {Item:{id:"minecraft:blackstone",Count:4b}}
execute if score @s mbomb.suc matches 2..3 run summon item ~ ~ ~ {Item:{id:"minecraft:blackstone",Count:2b}}
execute if score @s mbomb.suc matches 1 run summon item ~ ~ ~ {Item:{id:"minecraft:blackstone",Count:1b}}
