...
execute if score world spmobs.loaded matches 0 run scoreboard players set #overworld spmobs.cnt 75
execute if score world spmobs.loaded matches 0 run scoreboard players set #nether spmobs.cnt 75
execute if score world spmobs.loaded matches 0 run scoreboard players set #end spmobs.cnt 150
